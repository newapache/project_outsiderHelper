	  ...
	  <td>
	    ...
	    <br>	  	    
	  	<table style="background-color: YellowGreen">
	  	  <tr>
			<td width="120" align="center" bgcolor="E6ECDE" height="22">커뮤니티 ID</td>
		  ...
		  <tr>
			<td width="120" align="center" bgcolor="E6ECDE" height="22">설명</td>
			<td width="470" bgcolor="ffffff" style="padding-left: 10">
				${community.description} 
			</td>
		  </tr>		  
		  <tr>
			<td width="120" align="center" bgcolor="E6ECDE" height="22">개설일자</td>
			<td width="470" bgcolor="ffffff" style="padding-left: 10">
				${community.startDate} 
			</td>
		  </tr>		  
