...
<body bgcolor=#FFFFFF text=#000000 leftmargin=0 topmargin=0
	...
	<table style="width: 100%">
		<tr>
			<td width="20"></td>
			<td><a href="<c:url value='/user/logout' />">로그아웃(&nbsp;<%=curUserId%>&nbsp;)
			</a></td>
		</tr>
		<tr>
			<td>&nbsp;</td>
		...
		<tr>
			...
			<td>
				...
				<table style="background-color: YellowGreen">
					<tr>
						<td width="190" align="center" bgcolor="E6ECDE" height="22">사용자
							ID</td>
...
%>
				</table> <br> <a href="<c:url value='/user/register/form' />">사용자
					추가</a>
			</td>
		</tr>
	</table>
